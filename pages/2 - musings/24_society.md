...
* Professionalism and warmth: (to be expanded) "NL wins" <!--, but Bangalore is far better than Kolkata. dog poop; customer service bad in NL due to less people, DHL, going out of their way to help, e-commerce return pickup, shops being open on weekends,  -->
* Medical facilities: (to be expanded) "IN wins" <!-- time to service, easy relief antibiotics resistance is bad, social protection mediclaim, pension, bbq -->
* Others: UPI, apps like Porter, or NoBroker
